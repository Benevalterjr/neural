...
| **Tempo de Buffer Médio** | 6.19 segundos | **64.9 milissegundos** | **95× mais rápido** | Experiência fluida ✅ |
| **Startup Latency p95** | 12.55 segundos | **554.4 milissegundos** | **23× menor** | Sem engasgos ✅ |
| **Banda Total Consumida** | 2929.7 MB | **9.8 MB** | **300× menos tráfego** | Economia de rede 💸 |
| **Precisão de Recomendação** | 17.3% | **22.2%** | **1.3× melhor** | Recomendação P2P viável 🎯 |
| **Taxa de Retenção Média** | 29.9% | **37.6%** | **1.26× de engajamento** | Retenção superior 📈 |
...
No **PeerHive**, ao transmitir apenas os pesos neurais de **10KB** do HNeRV, o carregamento do vídeo leva apenas **64.9ms** (praticamente instantâneo). Isso viabiliza o modelo de feed infinito em redes descentralizadas.
...
A precisão de recomendação no PeerHive (**22.2%**) superou a do modelo sem sinalização dinâmica de feromônios. A difusão (gossip protocol) periódica de feromônios permitiu que nós vizinhos no overlay aprendessem tendências de engajamento locais de forma assíncrona, promovendo vídeos de qualidade sem a necessidade de um servidor de analytics centralizado.
